...
<body>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center white-text">Servicio automotriz</h1>
        ...
        <div class="row center">
          <a href="{{ route('sign-up') }}" id="download-button" class="btn-large waves-effect waves-light blue darken-2">Registrate</a>
        </div>
        <br><br>

      </div>
    </div>
    <div class="parallax"><img src="img/nissan-maxima.jpg" alt="Nissan Maxima"></div>
  </div>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center blue-text text-darken-2"><i class="material-icons">flash_on</i></h2>
            <h5 class="center blue-text text-darken-2">Speeds up development</h5>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center blue-text text-darken-2">User Experience Focused</h5>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center blue-text text-darken-2">Easy to work with</h5>
